...
export class SupervisorResolve implements Resolve<Supervisor> {
    user
    constructor(private supervisorAccountsServices: SupervisorAccountsServices,  route: ActivatedRoute,
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<Supervisor> | Promise<any> | any {
        ...
        return this.supervisorAccountsServices.getSupervisorService(route.params['id'])
